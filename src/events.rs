...
use crate::{DrawingApp, input, integration::IntegrationMethod, astronomy::AstronomicalObject};
            ...
            E::OnKeyPress => {
                if let K(key) = evt_data {
                    match key {
                        ...
                        109 => { let mut params = app.engine.params.lock().unwrap();
                            if params.use_target_speed {
                                params.target_speed /= 1.2;
                            } else {
                                params.time_step /= 1.2;
                        ...
                        77 => {
                            ...
                            params.method = match params.method {
                                ...
                                IntegrationMethod::RK4 => {
                                    IntegrationMethod::Symplectic(1)
                                }
                            };
                            *app.next_status_update.borrow_mut() = Instant::now();
                        },
